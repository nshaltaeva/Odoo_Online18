...
public class BasePage {
    ...
    @FindBy(xpath = "//*[normalize-space(text())='CRM']")
    public WebElement CRMModuleButton;
    ...
    public void navigateTo(String moduleName) {
        ...
        String moduleLocator = "//*[normalize-space(text())='"+moduleName+"']";
...
//        BrowserUtils.waitForPageToLoad(10);
    ...
    public void waitForPageSubTitle(String pageSubtitleText) {
        new WebDriverWait(Driver.get(), 10).until(ExpectedConditions.textToBe(By.cssSelector("head > title"), pageSubtitleText));
    }

    public void clickOnSignInButton(){
        BrowserUtils.waitForClickablility(signInButton,2);
    ...
    public void clickOnCRMModule(){
        BrowserUtils.waitForClickablility(CRMModuleButton, 2);
        BrowserUtils.clickWithWait(CRMModuleButton);
    }
